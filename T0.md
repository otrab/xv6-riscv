...
2. En el buzón de WebCampus, proporciona:
   - El enlace a tu rama en GitHub (https://github.com/tu_usuario/xv6-riscv/tree/grupo_t0)
...
## Evaluación
- Instalación exitosa de xv6: 25 puntos
- Ejecución correcta en QEMU (demostrada por la captura de pantalla): 20 puntos
- Calidad y completitud del informe: 10 puntos
- Correcta creación y uso de la rama en Git: 5 puntos
